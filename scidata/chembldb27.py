...
class Biotherapeutics(models.Model):
    ...
    molecule_dictionary = models.OneToOneField('MoleculeDictionary', models.DO_NOTHING, db_column='molregno', primary_key=True, related_name='molecule_dictionary_biotherapeutics')
...
class CompoundProperties(models.Model):
    # molecule_dictionary = models.ForeignKey('MoleculeDictionary', models.DO_NOTHING, db_column='molregno', primary_key=True)
    molecule_dictionary = models.OneToOneField('MoleculeDictionary', models.DO_NOTHING, db_column='molregno', primary_key=True, related_name='molecule_dictionary_compound_properties')
...
class CompoundStructures(models.Model):
    # molecule_dictionary = models.ForeignKey('MoleculeDictionary', models.DO_NOTHING, db_column='molregno', primary_key=True)
    molecule_dictionary = models.OneToOneField('MoleculeDictionary', models.DO_NOTHING, db_column='molregno', primary_key=True, related_name='molecule_dictionary_compound_structures')
