...
class SciData:
    """This class is used to generate and populate a SciData object to be output as a SciData JSON-LD document

    A SciData object is generated by calling the SciData class. The meta variable defines the keys that make up the
    backbone structure of the document. The class methods are called to populate the meta variable keys
    ...
    def context(self, context: list) -> dict:
        ...
        When called, the content of the @context key of the meta variable will be
        replaced with the supplied list of context files

        ie. SciDataObject.context(['https://stuchalk.github.io/scidata/contexts/scidata.jsonld']) """
    ...
    def add_context(self, context: str) -> dict:
        ...
        When called, the supplied list of context files will be appended to the list of any
        context files already present in the @context key of the meta variable"""
    ...
    def namespace(self, namespace: dict) -> dict:
        """Used to create or replace the dictionary of namespaces within @context

        When called, the dictionary of namespaces within the @context key of the meta variable will be
        replaced with the supplied dictionary of namespaces

        ie. SciDataObject.namespace({"sci": "https://stuchalk.github.io/scidata/ontology/scidata.owl#"}) """
    ...
    def add_namespace(self, namespace: dict) -> dict:
        ...
        When called, the supplied dictionary of namespaces will be added to the dictionary of namespaces
        within the @context key of the meta variable """
    ...
    def doc_id(self, i: str) -> dict: #TODO May be unneccesary if always an empty string that is populated later
        """Used to create or replace the value of the meta variable base level @id key"""

        self.meta['@id'] = i
        return self.meta

    def generatedat(self, i: str) -> dict:
        """Used to populate the generatedAt key of the meta variable with a timestamp
    ...
    def graph_id(self, i: str) -> dict:
        """Used to create or replace the @id within the @graph of the meta variable

        ie. SciDataObject.graph_id("https://scidata.unf.edu/<uniqueidentifier>/"""

        self.meta['@graph']['@id'] = i
        return self.meta

    def graph_type(self, i: str) -> dict: #TODO May be unneccesary if always "sdo:scidataFramework" as defined in meta
    ...
    def graph_uid(self, i: str) -> dict:
        """Used to create or replace the uid within the @graph of the meta variable
    ...
    def author(self, author: list) -> dict:
        """Used to create or replace the list of authors within the author key of the meta variable
    ...
    def title(self, title: str) -> dict:
        """Used to create or replace the title key within @graph of the meta variable
    ...
    def description(self, description: str) -> dict:
        """Used to create or replace the description key within @graph of the meta variable
    ...
    def publisher(self, publisher: str) -> dict:
        """Used to create or replace the publisher key within @graph of the meta variable
