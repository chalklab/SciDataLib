...
Documents = {6424}  ###Remove this line to process all Documents###
...
for DocumentNumber in Documents:
    ...
    test.version('X.X')
    test.keywords(['keyword 1', 'keyword 3'])
                ...
                for serial_table, serial_dict in serial.items():
                    if serial_table == 'activities':
                        ...
                        if deriveddata:
                            ...
                            deriveddataall.update(derivedmeta)
